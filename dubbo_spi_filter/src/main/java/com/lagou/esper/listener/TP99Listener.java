...
public class TP99Listener implements UpdateListener {
		...
		timer.schedule(new TimerTask() {
		        public void run() {
		            for(TPSResult result:resultList) {
		            	System.out.println("TP99  avg_val:"+result.getAvgVal() + " methodName:"+result.getMethodName());
		            }
		        }
		}, 5000 , 5000);
	}
	...
	private static class Singleton{
		private static TP99Listener instance;
		static {
			instance = new TP99Listener();
			instance.initSchedule();
		}
		public static TP99Listener getInstance() {
			return instance;
		}
	}
